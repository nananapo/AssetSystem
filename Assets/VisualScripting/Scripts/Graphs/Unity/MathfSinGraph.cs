...
{
    public class MathfSinGraph : Graph
    {

        public MathfSinGraph(string id) : base(id, true, true)
        {
        ...
        public override Task<ProcessCallResult> OnProcessCall(ProcessData args, object[] parameters)
        {
            ...
            return Task.FromResult(ProcessCallResult.Success(new object[]{Mathf.Sin(value)}, OutProcessNodes[0]));
        }

        public override string GraphName => "Mathf.Sin";
    }
}